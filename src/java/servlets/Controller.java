...
import comands.CmdFormulaire;
import comands.CmdHome;
import comands.IComand;
...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cmd != null || resultat == null) {
            IComand comand = (IComand) comands.get(cmd);
